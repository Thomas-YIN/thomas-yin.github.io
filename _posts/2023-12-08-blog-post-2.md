...
- [Probabilistic Generative Models](#probabilistic-generative-models-with-maximum-likelihood-estimation)
    - [Why do we care about the density of images $p(X)$?](#why-do-we-care-about-the-density-of-images-)
    - [The introduction of latent variable $z$](#the-introduction-of-latent-variable)
...
# <a name="pgm"></a>Probabilistic Generative Models (with maximum likelihood estimation)

## <a name="q"></a>Why do we care about the density of images $p(X)$?
...
## <a name="latent"></a>The introduction of latent variable $z$
...
# <a name="math"></a>The Math Behind VAE

## <a name="obj"></a>Deriving the objective function
...
## <a name="interp"></a>Interpreting the objective function
...
## <a name="assmp"></a>A few assumptions
...
## <a name="calc1"></a>Calculating the first term
...
## <a name="calc2"></a>Calculating the second term
